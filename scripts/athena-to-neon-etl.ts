...
// Configuration
const NEON_CONNECTION_STRING = 'postgresql://neondb_owner:npg_Inarx4C1bVmv@ep-snowy-dust-a5rl14da-pooler.us-east-2.aws.neon.tech/neondb?sslmode=require';
const AWS_REGION = process.env.AWS_REGION || 'us-east-1';
const ATHENA_DB_NAME = process.env.ATHENA_DB_NAME || 'default';
const ATHENA_OUTPUT_LOCATION = process.env.ATHENA_OUTPUT_LOCATION || 's3://wyatt-personal-aws-athena-results/';
